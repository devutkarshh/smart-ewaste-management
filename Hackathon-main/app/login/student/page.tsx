  ...
  return (
    <div className="w-full max-w-md relative z-10">
      <Card className="border-[#9ac37e]/20 shadow-2xl backdrop-blur-sm bg-card/95 dark:bg-card/90">
        <CardHeader>
          <CardTitle className="text-[#3e5f44] dark:text-[#9ac37e] text-2xl font-bold">Student / Resident Login</CardTitle>
          <CardDescription className="text-[#3e5f44]/70 dark:text-[#9ac37e]/70">Use your student credentials</CardDescription>
        </CardHeader>
        <CardContent>
          <form action="/api/auth/login" method="post" className="grid gap-4">
            ...
            <div className="text-center mt-2">
              <p className="text-sm text-[#3e5f44]/70 dark:text-[#9ac37e]/70">
                ...
                <Link href="/signup/student" className="text-[#3e5f44] dark:text-[#9ac37e] font-semibold hover:underline">
                  Sign up
                </Link>
              </p>
            </div>
