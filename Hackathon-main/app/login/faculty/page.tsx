    ...
    <main className="min-h-[100svh] grid place-items-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <Card className="border-[#9ac37e]/20 shadow-2xl backdrop-blur-sm bg-card/95 dark:bg-card/90">
          <CardHeader>
            <CardTitle className="text-[#3e5f44] dark:text-[#9ac37e] text-2xl font-bold">Faculty / Coordinator Login</CardTitle>
            <CardDescription className="text-[#3e5f44]/70 dark:text-[#9ac37e]/70">Use your email and password</CardDescription>
          </CardHeader>
          <CardContent>
